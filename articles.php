  ...
  <?php include "../blog/includes/header.php"; ?>
    ...
    <div id="content">
      ...
      <?php 
       ...
       echo "SELECT * FROM `articles` ORDER BY `id` DESC LIMIT $offset,$per_page";
      ...
      <?php 
           if( $articles_exist == true )
        {
          ...
          if( $page > 1 )
          {
            echo '<a href="/articles.php?page='.($page - 1).'"> &laquo; Last page </a>  ';
          } 
          if ( $page < $total_pages )
          {
            echo '<a href="/articles.php?page='.($page + 1).'" class="paginator_right"> Next page &raquo; </a>';
          }
          echo '</div>';
        }
      ?>
